...
void cpuStep(void) {
	...
	switch(instructions[instruction].operandLength) {
		case 0:
			(instructions[instruction].execute.sFunc.func_void)();
			break;
		
		case 1:
			(instructions[instruction].execute.sFunc.func_uchar)((unsigned char)operand);
			break;
		
		case 2:
			(instructions[instruction].execute.sFunc.func_ushort)(operand);
			break;
	}
...
static void andf (unsigned char value) {
	registers.a &= value;
...
static void orf(unsigned char value) {
	registers.a |= value;
...
static void xorf(unsigned char value) {
	registers.a ^= value;
...
void daa(void) {
	...
	//Add orf subtract correction values based on Subtract Flag
	if(!FLAGS_ISNEGATIVE) {
...
// 0xa0
void and_b(void) { andf(registers.b); }

// 0xa1
void and_c(void) { andf(registers.c); }

// 0xa2
void and_d(void) { andf(registers.d); }

// 0xa3
void and_e(void) { andf(registers.e); }

// 0xa4
void and_h(void) { andf(registers.h); }

// 0xa5
void and_l(void) { andf(registers.l); }

// 0xa6
void and_hlp(void) { andf(readByte(registers.hl)); }

// 0xa7
void and_a(void) { andf(registers.a); }

// 0xa8
void xor_b(void) { xorf(registers.b); }

// 0xa9
void xor_c(void) { xorf(registers.c); }

// 0xaa
void xor_d(void) { xorf(registers.d); }

// 0xab
void xor_e(void) { xorf(registers.e); }

// 0xac
void xor_h(void) { xorf(registers.h); }

// 0xad
void xor_l(void) { xorf(registers.l); }

// 0xae
void xor_hlp(void) { xorf(readByte(registers.hl)); }

// 0xaf
void xor_a(void) { xorf(registers.a); }

// 0xb0
void or_b(void) { orf(registers.b); }

// 0xb1
void or_c(void) { orf(registers.c); }

// 0xb2
void or_d(void) { orf(registers.d); }

// 0xb3
void or_e(void) { orf(registers.e); }

// 0xb4
void or_h(void) { orf(registers.h); }

// 0xb5
void or_l(void) { orf(registers.l); }

// 0xb6
void or_hlp(void) { orf(readByte(registers.hl)); }

// 0xb7
void or_a(void) { orf(registers.a); }
...
// 0xee
void xor_n(unsigned char operand) { xorf(operand); }
...
// 0xf6
void or_n(unsigned char operand) { orf(operand); }

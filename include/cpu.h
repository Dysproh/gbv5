...
struct funcsOnion {
  void (*func_void  )(void);
  void (*func_char  )(char);
  void (*func_ushort)(unsigned short);
  void (*func_uchar )(unsigned char);
};
...
class strangeFunction {
  public:
    ...
    int fType;
    struct funcsOnion sFunc;
  public:
    strangeFunction(void (*inFunc) (void)) {
      sFunc.func_void = inFunc;
      fType = VV;
    }
    void operator=(void (*inFunc) (void)) {
      sFunc.func_void = inFunc;
      fType = VV;
    }


    strangeFunction(void (*inFunc) (char)) {
      sFunc.func_char = inFunc;
      fType = VC;
    }
    void operator=(void (*inFunc) (char)) {
      sFunc.func_char = inFunc;
      fType = VC;
    }
    ...
    strangeFunction(void (*inFunc) (unsigned short)) {
      sFunc.func_ushort = inFunc;
      fType = VUS;
    }
    void operator=(void (*inFunc) (unsigned short)) {
      sFunc.func_ushort = inFunc;
      fType = VUS;
    }
    ...
    strangeFunction(void (*inFunc) (unsigned char)) {
      sFunc.func_uchar = inFunc;
      fType = VUS;
    }
    void operator=(void (*inFunc) (unsigned char)) {
      sFunc.func_uchar = inFunc;
      fType = VUS;
    }
    operator std::function<void(unsigned char)> () {
      return (std::function<void(unsigned char)>) sFunc.func_uchar;
    }
};
